...
class Converter {
    ...
    fun convertRoomToRoomSerialization(room: Room): RoomSerialization {
        ...
        return RoomSerialization(room.id, room.roomName, room.author, usersSerialization, room.access)
    }
    ...
    fun convertRoomSerializationToRoom(room: RoomSerialization): Room {
        ...
        return Room(room.id, room.roomName, room.author, users, room.access)
    }
